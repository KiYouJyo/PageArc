...
internal interface IMsixPackageSignatureVerifier
{
    MsixPackageSignatureVerificationResult Verify(string packagePath);
}

internal sealed record MsixPackageSignatureVerificationResult(
    bool IsValid,
    string FailureCode,
...
/// <summary>
/// Verifies the Windows trust chain for an MSIX/MSIXBundle and then reads the
/// package's AppxSignature.p7x to pin the certificate actually used to sign it.
/// This mirrors SpatialViewer's product-update verifier.
/// </summary>
internal sealed class MsixPackageSignatureVerifier : IMsixPackageSignatureVerifier
{
    ...
    public MsixPackageSignatureVerificationResult Verify(string packagePath)
    {
        if (!OperatingSystem.IsWindows()) return new(false, "SignatureInvalid");

        var fileInfo = new WinTrustFileInfo(packagePath);
        ...
        try
        {
            ...
            try
            {
                ...
                return certificate is null
                    ...
                    : new(true, "PackageSignatureVerified", certificate.Subject, certificate.Thumbprint, result);
            }
